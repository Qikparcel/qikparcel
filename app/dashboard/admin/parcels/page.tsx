      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            <input
              type="text"
              placeholder="Search by sender name, phone, email or address..."
              value={searchQuery}
              onChange={(e) => {
            ...
            <p className="mt-1 text-xs text-gray-500">
              e.g. type a sender&apos;s name, phone number, or part of an
              address to find their parcels
            </p>
          </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        <button
                          ...
                          style={{ color: "#29772F" }}
                          title="Show parcels by this sender"
                        >
                          {parcel.sender?.full_name || "N/A"}
                        </button>
                      </div>
                      <div className="text-xs text-gray-500">
                        {parcel.sender?.phone_number ||
                          parcel.sender?.email ||
                          ""}
                      </div>
                    </td>
                            ...
                            <div key={match.id} className="text-xs">
                              ...
                              {match.trip && (
                                <div className="mt-1 text-gray-600">
                                  ...
                                  >
                                    Trip:{" "}
                                    {match.trip.origin_address.substring(0, 30)}
                                    ...
                                  </Link>
                                  {match.trip.courier && (
                                    <div className="text-gray-500">
                                      Courier:{" "}
                                      {match.trip.courier.full_name ||
                                        match.trip.courier.phone_number}
                                    </div>
                                  )}
                                </div>
                              )}
