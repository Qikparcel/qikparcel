...
export default function AdminUserDetailPage() {
      ...
      try {
        ...
        if (ratingsRes.ok) {
          ...
          if (rData.success) {
            ...
            setAverageRating(rData.averageRating ?? null);
          }
        }
      } catch (error) {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <span
              className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${
                roleColors[userData.role] || "bg-gray-100 text-gray-800"
              }`}
            >
              {userData.role}
            </span>
          ...
          <div>
            ...
            <p className="text-gray-900">
              {userData.whatsapp_number || "Not provided"}
            </p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-500">
      ...
      {/* Ratings Section - show when user has received ratings */}
      {ratings.length > 0 && (
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">
                    ...
                    <tr key={trip.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4">
                        <span
                          className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                            statusColors[
                              trip.status as keyof typeof statusColors
                            ] || "bg-gray-100 text-gray-800"
                          }`}
                        >
                          {trip.status}
