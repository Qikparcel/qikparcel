...
type StatusHistoryWithProof = StatusHistory & {
...
interface ParcelTimelineProps {
  statusHistory: StatusHistoryWithProof[];
...
> = {
  pending: {
    ...
    icon: "⏳",
    explanation:
      "Parcel request created and waiting to be matched with a traveller",
  },
  matched: {
    label: "Matched",
    ...
    icon: "🤝",
    explanation:
      "Parcel has been matched with a verified traveller heading in the same direction",
  },
  picked_up: {
    label: "Picked Up",
  ...
  cancelled: {
    ...
    icon: "✗",
    explanation:
      "Delivery has been cancelled. Refund depends on cancellation stage",
  },
};
            ...
            return (
              <div key={status} className="relative flex items-start gap-4">
                ...
                <div className="relative group/dot z-10">
                  <div
                    className={`flex items-center justify-center w-8 h-8 rounded-full border-2 cursor-help ${
                      isCompleted
                        ? isCurrent
                ...
                <div className="flex-1 pt-1">
                  <div className="relative group inline-block">
                    <div
                      className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium border cursor-help ${
                        isCurrent
                          ? config.color
                          : isCompleted
                  ...
                  {historyEntry && (
                    <div className="mt-2">
                      ...
                      {historyEntry.proof_photo_url && (
                        <div className="mt-2">
                          <p className="text-xs text-gray-500 mb-1">
                            Proof photo
                          </p>
                          <a
                            href={historyEntry.proof_photo_url}
                            target="_blank"
                          ...
                          >
                            <img
                              ...
                              alt={`${status} proof`}
                              className="w-36 h-24 object-cover rounded border border-gray-200 hover:opacity-90 transition"
                            />
                          </a>
                        </div>
                      )}
                      {historyEntry.proof_required &&
                        historyEntry.has_proof_photo === false && (
